					...
					'fields' => array(
						...
						'telephone' => array(
								...
								'error' => array(0 => array('min_length' => 3, 
												 ...
												 1 => array('regex' => '/^[0]{1}[1-9]{1}[0-9]{8,9}|^[+]{1}[1-9]{2}[0-9]{8,9}$/i', 
															 'text' => 'error_field_required')),
								'type' => 'text',
								'refresh' => '0',
								'custom' => 0,
								'sort_order' => 4,
			...
			'payment_address' => array(
				...
				'fields' => array(
					...
					'telephone' => array(
										 ...
										 'error' => array(0 => array('min_length' => 3, 
															 'max_length' => 32, 
															 'text' => array(1 => 'Sorry, but you need to have the length of the text more then 3 and less then 32 ')),
												  1 => array('regex' => '/^[0]{1}[1-9]{1}[0-9]{8,9}|^[+]{1}[1-9]{2}[0-9]{8,9}$/i', 
															 'text' => 'error_field_required'),

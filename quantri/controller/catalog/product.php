...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
		...
		$data['sort_category'] = $this->url->link('catalog/product', 'token=' . $this->session->data['token'] . '&sort=p.category_id' . $url, 'SSL');
		...
		$categories = $this->model_catalog_category->getCategories2(0);

		foreach ($categories as $category) {
				// Level 2
				$children_data = array();

				$children = $this->model_catalog_category->getCategories2($category['category_id']);
				...
				foreach ($children as $child) {
					...
					$children2 = $this->model_catalog_category->getCategories2($child['category_id']);
	...
	protected function getForm() {
		...
		if (isset($this->request->post['date_added'])) {
			...
			$data['date_added'] = ($product_info['date_added'] != '0000-00-00 00:00:00') ? $product_info['date_added'] : '';
		} else {

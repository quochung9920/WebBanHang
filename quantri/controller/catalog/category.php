...
class ControllerCatalogCategory extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['image_banner'])) {
			$data['image_banner'] = $this->request->post['image_banner'];
		} elseif (!empty($category_info)) {
			$data['image_banner'] = $category_info['image_banner'];
		} else {
			$data['image_banner'] = '';
		}

		if (isset($this->request->post['image_banner_mobile'])) {
			$data['image_banner_mobile'] = $this->request->post['image_banner_mobile'];
		} elseif (!empty($category_info)) {
			$data['image_banner_mobile'] = $category_info['image_banner_mobile'];
		} else {
		...
		if (isset($this->request->post['image_banner']) && is_file(DIR_IMAGE . $this->request->post['image_banner'])) {
			$data['thumb_banner'] = $this->model_tool_image->resize($this->request->post['image_banner'], 100, 100);
		} elseif (!empty($category_info) && is_file(DIR_IMAGE . $category_info['image_banner'])) {
			$data['thumb_banner'] = $this->model_tool_image->resize($category_info['image_banner'], 100, 100);
		} else {
			$data['thumb_banner'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}

		if (isset($this->request->post['image_banner_mobile']) && is_file(DIR_IMAGE . $this->request->post['image_banner_mobile'])) {
			$data['thumb_banner_mobile'] = $this->model_tool_image->resize($this->request->post['image_banner_mobile'], 100, 100);
		} elseif (!empty($category_info) && is_file(DIR_IMAGE . $category_info['image_banner_mobile'])) {
			$data['thumb_banner_mobile'] = $this->model_tool_image->resize($category_info['image_banner_mobile'], 100, 100);
		} else {
			$data['thumb_banner_mobile'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}

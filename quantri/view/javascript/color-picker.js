(function ($) {
        ...
        return this.each(function () {
            ...
            **/
            ...
            element.bind("change", function () {
                ...
                opts.callback.call(orginal,$(this).val());
            });
    ...
    **/
    $.fn.colorPicker.defaults = {
        ...
        // Default color set.
        colors : [
            '000000', '800000', 'FF0000', 'FF6600', 'FFFF00', '008000', '0000FF', '551A8B',
            '3B3B3B', '993300', 'FF99CC', 'FC813B', 'FCD116', 'A3CF2C', '359BED', 'CC00FF',
            '808080', '603311', 'FFCCCC', 'FFA500', 'FFF68F', 'DFFFA5', '63B8FF', 'DB70DB',
			'FFFFFF', ''
...
/** ^ End of Plugin ^
* Now applying it to our input fields.
* I need to call callback function, when the colour has changed
* and updated the input field value
*/
$('.colours').colorPicker({ callback : function (color){
}});
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div id="menu-erea" class="panel panel-body">
        <div class="left">
          <div class="panel-group" id="accordion">
            <div class="panel panel-default">
              ...
              <div class="panel-heading">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#block-category"><?php echo $text_category; ?></a></h4>
              </div>
        ...
        <div class="right">
          <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form"><div class="dd" id="menu_area"><ol class='dd-list'><?php $model->getMenuHtml(0);?></ol></div><input id="custom_data" type="hidden" name="custom_data" value="" /></form>
        </div>
      </div>
      <!-- end menu --> 
    </div>
...
function get_content_obj(obj){
  ...
  "</div><div class='info hide'>"+
        "<p class='input-item'><span class='type'>" +jQuery(obj).attr('class')+ "</span></p>"+
        ...
        "</div>"+
        <?php } ?>
        "<p class='input-item'><a class='remove' onclick='remove_item(this);'><?php echo $text_remove; ?></a></p>"+
        ...
        "</div>"+
      "</div><a class='explane' onclick='explane(this)'><?php echo $text_explane; ?></a></li>";
  return result;
}
function get_content_obj_custom(obj){
  ...
  "</div>" + 
  "</div><div class='info hide'>"+
        "<p class='input-item'><span class='type'>Custom</span></p>"+        
        <?php foreach($languages as $language) { ?>
        "<div class='input-group'>"+
        ...
        <?php } ?>
        urlhtml +
        "<p class='input-item'><a class='remove' onclick='remove_item(this);'><i class='fa fa-trash'></i> <?php echo $text_remove; ?></a></p>"+
        "<p class='input-item'><a  href='javascript:void(0);' class='activemega active' onclick='activemega(this);'><?php echo $text_active_mega; ?></a></p>"+
        "<div class='hidden-data'>" +

      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="post" value="" placeholder="<?php echo $entry_product; ?>" id="input-post" class="form-control" />
              <div id="featured-post" class="well well-sm" style="height: 150px; overflow: auto;">
                <?php foreach ($posts as $post) { ?>
                <div id="featured-post<?php echo $post['post_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $post['name']; ?>

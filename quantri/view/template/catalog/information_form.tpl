        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-information" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-bottom"><span data-toggle="tooltip" title="Hiển thị tại Footer - Thông tin">Hiển thị ở Thông tin</span></label>
                <div class="col-sm-10">
                  <div class="checkbox">
                    <label>
                      <?php if ($bottom) { ?>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-bottom2"><span data-toggle="tooltip" title="Hiển thị tại Footer - Trên Bộ Công Thương"><?php echo $entry_bottom; ?></span></label>
                <div class="col-sm-10">
                  <div class="checkbox">
                    <label>
                      <?php if ($bottom2) { ?>

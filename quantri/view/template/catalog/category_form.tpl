        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $entry_image; ?><br>(570x570px)</label>
                <div class="col-sm-10"><a href="" id="thumb-image" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="image" value="<?php echo $image; ?>" id="input-image" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $entry_image_banner; ?> Desktop<br>(1900x350px)</label>
                <div class="col-sm-4"><a href="" id="thumb-image_banner" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb_banner; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="image_banner" value="<?php echo $image_banner; ?>" id="input-image_banner" />
                </div>
                <label class="col-sm-2 control-label"><?php echo $entry_image_banner; ?> Mobile<br>(750x730px)</label>
                <div class="col-sm-4"><a href="" id="thumb-image_banner_mobile" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb_banner_mobile; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="image_banner_mobile" value="<?php echo $image_banner_mobile; ?>" id="input-image_banner_mobile" />
                </div>
              </div>
              <div class="form-group hidden">

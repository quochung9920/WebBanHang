        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-image">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-category">Ảnh mặc định danh mục Desktop<br>(1900x350px)</label>
                <div class="col-sm-4"><a href="" id="thumb-category" data-toggle="image" class="img-thumbnail"><img src="<?php echo $category; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="config_category" value="<?php echo $config_category; ?>" id="input-category" />
                </div>
                <label class="col-sm-2 control-label" for="input-category_mobile">Ảnh mặc định danh mục Mobile<br>(750x730px)</label>
                <div class="col-sm-4"><a href="" id="thumb-category_mobile" data-toggle="image" class="img-thumbnail"><img src="<?php echo $category_mobile; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="config_category_mobile" value="<?php echo $config_category_mobile; ?>" id="input-category_mobile" />
                </div>
              </div>

              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-logo_share_fb"><?php echo $entry_logo_share_fb; ?></label>
                <div class="col-sm-10"><a href="" id="thumb-logo_share_fb" data-toggle="image" class="img-thumbnail"><img src="<?php echo $logo_share_fb; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="config_logo_share_fb" value="<?php echo $config_logo_share_fb; ?>" id="input-logo_share_fb" />
                </div>
              </div>

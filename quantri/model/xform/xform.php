	   ...
	   elseif($recordFieldData['fieldType'] =='file')
	   {
		  ...
		  if($ext){
			 if($ext=='jpg' || $ext=='png' || $ext=='gif' || $ext=='jpeg'){
			   $file='<a target="_blank" href="'.str_replace('/quantri','',HTTP_SERVER.'image/xform/'.$recordFieldData['fieldValue']).'"><img src="'.str_replace('/quantri','',HTTP_SERVER.'image/xform/'.$recordFieldData['fieldValue']).'" width="150" /></a>';	 
		     }else{

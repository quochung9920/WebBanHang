          ...
          <div class="product-list-item js_product_chung">
              <div class="product-list-item_wrap">
                  ...
                  <div class="product-list-item_wrap-2">
                      ...
                      <div class="btn-group">
                          <button class="cta-link-button product-list-item__add-to-cart-btn js_product-list-item__add-to-cart-btn js_product-item_add-to-card order-md-1 stock-subscription__add-to-cart-btn btn--add-to-cart show js_addtocart__btn" onclick="js_addtocart__btn($(this));" data-product-code="<?php echo $product['product_id']; ?>" data-product-minimum="<?php echo $product['minimum']; ?>" data-product-name="<?php echo $product['name']; ?>" gtm-initialized-add-to-cart="true"><?php echo $button_cart; ?></button>

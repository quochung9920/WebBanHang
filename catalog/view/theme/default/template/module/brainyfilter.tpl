...
<div class="bf-panel-wrapper<?php if($isResponsive) : ?> bf-responsive<?php endif; ?> <?php echo $responsivePos; ?> bf-layout-id-<?php echo $layout_id;?>">
    ...
    <div class="box bf-check-position <?php if ($isHorizontal) : ?>bf-horizontal<?php endif; ?>">
        <div class="box-heading"><span class="lang_block_title"><?php echo $lang_block_title; ?></span><span class="closebfmobile"></span><?php if ($isHorizontal) : ?><a class="bf-toggle-filter-arrow"></a><input type="reset" class="bf-buttonclear" onclick="BrainyFilter.reset();" value="<?php echo $reset; ?>" /><?php endif; ?></div>
        <div class="brainyfilter-panel box-content <?php if ($settings['submission']['hide_panel']) : ?>bf-hide-panel<?php endif; ?>">
            <form class="bf-form 
                ...
                <?php if (!$isHorizontal || $settings['submission']['submit_type'] == 'button') : ?><div class="bf-buttonclear-box"<?php if ($isHorizontal && $settings['submission']['submit_button_type'] == 'float') : ?>style="display:none;"<?php endif; ?>>
                   ...
                   <?php if (!$isHorizontal) : ?><input type="reset" class="button white product-filter_btn product-filter_btn-reset js_product-filter_btn-reset" onclick="BrainyFilter.reset();return false;" value="<?php echo $text_khoiphuclai; ?>" /><?php endif; ?>  
                </div><?php endif; ?>
            </form>
        </div>
        <div class="bf_reset_mobile">
            <a class="button white product-filter_btn product-filter_btn-reset js_product-filter_btn-reset" href="javascript:void(0)" onclick="BrainyFilter.reset();return false;"><?php echo $text_khoiphuclai; ?></a>
            <a class="product-filter_btn button primary js_product-filter_btn-apply" href="javascript:void(0)"><?php echo $text_apdungboloc; ?></a>
        </div>
    </div>
</div>
<script>

    ...
    //        var searchFilters = {};
        ...
        shrinkBlock: function(block, items, disableAnim) {
            ...
            if (!items) {
                ...
                $(block).closest('.bf-attr-block').find('.bf-arrow').addClass('openq');
                // if($(block).closest('.bf-attr-block').find('.bf-arrow').hasClass('openq')){
        ...
        expandBlock: function(block, disableAnim) {
            ...
            $(block).parents('.bf-attr-block').find('.bf-arrow').removeClass('openq');
        },
        ...
        collapse: function() {
            ...
            $('.bf-collapse').parents('.bf-attr-block').find('.bf-arrow').addClass('openq');

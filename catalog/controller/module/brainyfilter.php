...
class ControllerModuleBrainyFilter extends Controller {
	...
	public function index($moduleSettings) 
    {
        ...
        if ($isMijoShop) {
            MijoShop::get('base')->addHeader(JPATH_MIJOSHOP_OC . '/catalog/view/javascript/brainyfilter_18012022.js', false);
        } else {
            $this->document->addScript('catalog/view/javascript/brainyfilter_18012022.js');
        }
        ...
        $this->_data['text_khoiphuclai']      = $this->language->get('text_khoiphuclai');
        $this->_data['text_apdungboloc']      = $this->language->get('text_apdungboloc');

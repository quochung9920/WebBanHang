			...
			foreach ($subcats as $subcat) {
				...
				foreach ($subresults as $subresult) {
					...
					$subproducts[] = array(
						...
						'description' 	=> (strlen(strip_tags(html_entity_decode($subresult['description'], ENT_QUOTES, 'UTF-8'))) > $this->config->get('config_product_description_length') ?  $this->model_tool_image->catchu(strip_tags(html_entity_decode($subresult['description'], ENT_QUOTES, 'UTF-8')),$this->config->get('config_product_description_length')) . '...' : strip_tags(html_entity_decode($subresult['description'], ENT_QUOTES, 'UTF-8'))),

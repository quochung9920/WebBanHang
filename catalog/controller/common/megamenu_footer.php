<?php
class ControllerCommonMegaMenuFooter extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/megamenu_footer.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/common/megamenu_footer.tpl', $data);
		} else {
			return $this->load->view('default/template/common/megamenu_footer.tpl', $data);
		}
	}
}